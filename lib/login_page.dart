...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> _login() async {
    ...
    try {
      final url = '${AppConstants.baseUrl}/login';
  ...
  Future<void> _registerBiometric(String identifier, String password) async {
    try {
      ...
      if (authenticated) {
        ...
        final url = '${AppConstants.baseUrl}/register_biometric';
  ...
  Future<void> _loginWithBiometric() async {
    ...
    try {
      ...
      if (authenticated) {
        ...
        final url = '${AppConstants.baseUrl}/login_biometric';
        final response = await http.post(
          Uri.parse(url),
  ...
  Future<void> _handleGoogleSignIn() async {
    try {
      ...
      final url = '${AppConstants.baseUrl}/google_login';
      final response = await http.post(
        Uri.parse(url),
        body: {
          'email': email,
