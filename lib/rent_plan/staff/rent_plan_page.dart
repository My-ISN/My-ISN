    ...
    return InkWell(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(16),
          border: Border.all(
            color: isActive ? primaryPurple : Colors.grey.withValues(alpha: 0.2),
            width: isActive ? 2 : 1,
          ),
          boxShadow: isActive
              ? [
                ...
                if (index == 0) {
                  return Padding(
                    ...
                    child: PaginationHeader(
                      ...
                      totalLabel: 'rent_plan.total_count'.tr(context, args: {'count': _totalCount.toString()}),
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Icon(
            ...
            color: isActive
                ? _primaryColor
                : (isDark ? Colors.white.withValues(alpha: 0.4) : Colors.grey.withValues(alpha: 0.3)),
            size: 24,
          ),
        ),
      ),
