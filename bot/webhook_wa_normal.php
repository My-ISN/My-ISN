...
if ($type !== 'text' || empty($text) || $isGroup) {
    logIt("SKIP: bukan teks/grup"); http_response_code(200); exit('OK');
}
...
// Baca system prompt dari config, atau pakai default
...
// Sisipkan {customer} dan {knowledge} jika ada placeholder, atau append otomatis
